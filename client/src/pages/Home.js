        ...
        <div className="flex flex-wrap items-center mt-20 text-left justify-center">
          ...
          <div className="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
            ...
            <p className="sm:text-lg mt-6">
              Welcome to BeeAware, a dedicated platform aimed at raising
              awareness about the vital role of local pollinators in Florida. We
              are passionate about promoting the significance of these essential
              creatures and the invaluable service they provide to our
        ...
        <div className="flex flex-wrap flex-row-reverse items-center mt-20 text-left justify-center">
          <div className="w-full md:w-3/4 lg:w-1/2 px-4">
            <img
              src={Bees}
              alt="bulk"
              className="rounded-full  h-64 m-auto"
            ></img>
          </div>
          <div className="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
            <h2 className="text-4xl font-extrabold leading-10 tracking-tight text-gray-800 sm:text-5xl sm:leading-none md:text-6xl">
            ...
            <p className="sm:text-lg mt-6">
              ...
              central brood nest regardless of whether the outside temperature
