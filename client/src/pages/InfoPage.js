...
const Info = () => {
    ...
    return (
        <main>
            ...
            <div className="card-container flex flex-col pb-10 lg:flex-row-reverse lg:px-36 lg:py-11 justify-center gap-28">
                <div className="card-container img-1">
