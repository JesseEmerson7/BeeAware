    ...
    return (
        <main>
            <div className="card-container">
                <img className="w-full h-72 opacity-75"
                    id="bckgrd-img"
                    src={backgroundImage}
                    alt="Bee on a Flower Image"
                />
                <p className="card-content text-2xl mt-8 leading-10 absolute top-44 pl-[50%] pr-[5%] font-medium"> There are many different types of bees, hornets and wasps in Florida. Here are some of the different species to be on the look out for.</p>
            </div>
            ...
            <div className="card-container flex flex-row px-36 py-11 gap-32">
                <div className="card-container">
                    <img className="card-content object-contain"
                        id="beePic2"
                        src={brownBelted}
            ...
            <div className="card-container flex flex-row-reverse px-36 py-11 gap-32">
                ...
                <div className="card-content w-2/3" >
                    <p className="pl-16" > Honeybees are known for their construction of perennial colonial nests from wax, the large size of their colonies, and surplus production and storage of honey, distinguishing their hives as a prized foraging target of many animals, including honey badgers, bears and human hunter-gatherers. Honeybees can thrive in natural or domesticated environments, though they prefer to live in gardens, woodlands, orchards, meadows and other areas where flowering plants are abundant. Within their natural habitat, honeybees build nests inside tree cavities and under edges of objects to hide themselves from predators. Honeybees: you either love them or hate them. The latter is understandable – the idea of a bee sting can inspire fear in even the bravest of humans, especially if they happen to be allergic. But the truth is, these insects really do more good than harm.</p>
                </div>
            </div>
            <div className="text-3xl text-center">Orchid Bee</div>
            <div className="card-container flex flex-row px-36 py-11 gap-32">
                <div className="card-container">
                    <img className="card-content object-contain"
                        id="beePic10"
