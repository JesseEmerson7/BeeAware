...
const Info = () => {
    ...
    return (
        <main>
            ...
            <div className="card-container border flex space-x-40">
                <div className="pl-24 py-4 w-1/2 flex items-center">
                    <p className="card-content text-2xl mt-8 leading-10"> There are many different types of bees, hornets and wasps in Florida. Here are some of the different species to be on the look out for.</p>
                </div>
