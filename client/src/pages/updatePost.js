...
//query for single post to get id and populate values.
  ...
  return (
    <>
    <div id="alert-border-4" className={isVisible? 'flex p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-300 dark:bg-gray-800 dark:border-yellow-800': 'hidden'} role="alert">
    ...
    <div>
      ...
      <input
        ...
        required
        name="title" value={updateState.title} onChange={handleFormChange}
      />
    </div>
    <div>
      <label
      ...
      <input
        ...
        className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-yellow-500 focus:border-yellow-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
        required
        name="description" value={updateState.description
    ...
    <textarea
      ...
      required
      name="body" value={updateState.body} onChange={handleFormChange}
    ></textarea>
